...
export const envSchema = z.object({
  ...
  WHOOP_TOTEM_CREDENTIALS_TEXT: z.string().optional(),
  WHOOP_TOTEM_CREDENTIALS_BASE64: z.string().optional(),
  MFP_COOKIE_FILE: z.string().optional(),
  MFP_COOKIE_TEXT: z.string().optional(),
  MFP_COOKIE_BASE64: z.string().optional(),
